...
import { UploadCloud, FileText, ShieldQuestion } from 'lucide-react';

const FileInputField = ({ id, label, required = true, onChange, file, isSubmitting, icon, accept }) => (
...
const AdultDocumentUploadSection = ({ formData, handleFileChange, isSubmitting }) => {
  return (
    <>
...
export default AdultDocumentUploadSection;